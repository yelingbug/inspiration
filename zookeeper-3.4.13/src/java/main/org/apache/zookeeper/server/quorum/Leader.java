...
public class Leader {
    ...
    public void waitForNewLeaderAck(long sid, long zxid)
        ...
        synchronized (newLeaderProposal.ackSet) {
            ...
            /**
             * waitForNewLeaderAck方法在{@link LearnerHandler}(由{@link LearnerCnxAcceptor里对每个follower启动一个线程})里在也会被调用,
             * 所以这里当不够大多数server act时,选择wait,等到够时,{@link LearnerHandler}会继续调用这个方法,在这里notifyAll.
             */
