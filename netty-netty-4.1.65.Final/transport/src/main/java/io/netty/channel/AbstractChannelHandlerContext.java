...
abstract class AbstractChannelHandlerContext implements ChannelHandlerContext, ResourceLeakHint {
    ...
    AbstractChannelHandlerContext(DefaultChannelPipeline pipeline, EventExecutor executor,
        ...
        /**
         * 计算<code>handlerClass</code>中存在的所有对应方法的掩码值(
         * 参考{@link ChannelHandlerMask#MASK_ALL_INBOUND}和{@link ChannelHandlerMask#MASK_ALL_OUTBOUND}).
         * 比如某个handlerClass是个{@link ChannelInboundHandler}，那么executionMask的值就等于{@link ChannelHandlerMask#MASK_ALL_INBOUND}，
         * 除非其中的方法上附加了{@link io.netty.channel.ChannelHandlerMask.Skip}注解.
         * commented by Yelin.G on 2021.07.28
         */
    ...
    private void invokeFlush() {
        /**
         * 如果当前handler的状态不适合处理过来的event(通过{@link #invokeHandler()}判断)，forward
         * 给下一个可处理的handler.
         * commented by Yelin.G on 2021.07.28
         */
        if (invokeHandler()) {
    ...
    private AbstractChannelHandlerContext findContextInbound(int mask) {
        ...
        do {
            ctx = ctx.next;
            /**
             * 找到下一个有效的{@link ChannelHandlerContext}，因为{@link ChannelHandlerContext}的具体实现可能通过
             * {@link io.netty.channel.ChannelHandlerMask.Skip}标识为无效.
             * commented by Yelin.G on 2021.07.28
             */
