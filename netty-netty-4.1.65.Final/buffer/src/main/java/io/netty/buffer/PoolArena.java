...
abstract class PoolArena<T> extends SizeClasses implements PoolArenaMetric {
    ...
    protected PoolArena(PooledByteBufAllocator parent, int pageSize,
        ...
        /**
         * 为subPage范围的规格分配缓存，是否是subPage是在{@link SizeClasses}预计算的时候确定的，对jemalloc4来说
         * 是39个，从16B到28K(参照https://slowisfast.feishu.cn/docs/doccnYyE0B0QX9F7CxObPFrBglc)文档中的
         * 表格，所以这里的 numSmallSubpagePools=39
         *
        ...
        for (int i = 0; i < smallSubpagePools.length; i ++) {
            /**
             * 每个数组下会挂一个链表，对39个数组元素初始化一个链表，初始时指向自己。
             *
             * commented by Yelin.G on 2021.12.29
             */
    ...
    private void allocate(PoolThreadCache cache, PooledByteBuf<T> buf, final int reqCapacity) {
        /**
         * 分配时先对请求先从{@link SizeClasses}预计算的表格进行规整，简单点说就是规整出来的size必须是
         * 表格中的某一项。
         *
         * commented by Yelin.G on 2021.12.29
         */
