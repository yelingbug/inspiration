...
public class PooledByteBufAllocator extends AbstractByteBufAllocator implements ByteBufAllocatorMetricProvider {
    ...
    public PooledByteBufAllocator(boolean preferDirect, int nHeapArena, int nDirectArena, int pageSize, int maxOrder,
        ...
        /**
         * 默认值是基于JVM运行时最大内存计算出多少个{@link PoolArena}，计算逻辑参见{@link #DEFAULT_NUM_HEAP_ARENA}.
         *
        ...
        /**
         * 默认值是基于宿主机或者虚拟机的最大内存计算出多少个{@link PoolArena}，计算逻辑参见{@link #DEFAULT_NUM_DIRECT_ARENA}.
         *
         * commented by Yelin.G on 2021.12.31
         */
        if (nDirectArena > 0) {
    ...
    private static int validateAndCalculatePageShifts(int pageSize, int alignment) {
        ...
        /**
         * 判断一个值是不是2的幂次方，这个是个比较好的办法。
         *
         * Integer.numberOfLeadingZeros(pageSize)：这个方法返回无符号整数i的最高非0位前面的0的个数，包括符号位在内；
         * 如果i为负数，这个方法将会返回0，符号位为1。比如说，10的二进制表示为 0000 0000 0000 0000 0000 0000 0000 1010，
         * Java的整型长度为32位。那么这个方法返回的就是28。
         *
         * 多补充一点B，KB，MB等之间的换算技巧：
         * <pre>
         ...
         * </pre>
         *
         * commented by Yelin.G on 2021.11.02
         */
    ...
    private static int validateAndCalculateChunkSize(int pageSize, int maxOrder) {
        ...
        /**
         * defaultMaxOrder = 11 (8192 << 11 = 16 MiB per chunk)
         * MAX_CHUNK_SIZE = 1073741824
         * MAX_CHUNK_SIZE / 2 = 536870912
         *
         * 对缺省值来说，这里的chunkSize = 16777216(16M)，最大不能超过MAX_CHUNK_SIZE / 2
         *
    ...
    final class PoolThreadLocalCache extends FastThreadLocal<PoolThreadCache> {
        ...
        private <T> PoolArena<T> leastUsedArena(PoolArena<T>[] arenas) {
            ...
            /**
             * 每个线程初始化的时候会从arenas数组中查找被线程数占用最少的{@link PoolArena}来分配内存，这样做的
             * 目的是资源使用的平衡。
             *
             * commented by Yelin.G on 2021.12.31
             */
