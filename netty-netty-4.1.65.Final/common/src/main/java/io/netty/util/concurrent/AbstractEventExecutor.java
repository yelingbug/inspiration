...
public abstract class AbstractEventExecutor extends AbstractExecutorService implements EventExecutor {
    ...
    /**
     * 设计上为了遵循其设计思想，创建一个包含自身的单集合对象，满足接口契约。按照常规的思路，为什么要创建
     * 这个单集合，难道不会有开销吗？是不是搞复杂了？我想可能也是大部分程序员的一个想法，如何在设计和负载
     * 之间寻找一个平衡，是经验更是一门艺术或者是哲学？
     * commented by Yelin.G on 2021.06.27
     */
    @Override
