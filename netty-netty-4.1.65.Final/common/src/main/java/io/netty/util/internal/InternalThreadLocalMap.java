...
public final class InternalThreadLocalMap extends UnpaddedInternalThreadLocalMap {
    ...
    /**
     * {@link #fastGet(FastThreadLocalThread)}和{@link #slowGet()}的区别在于，一个是
     * 用{@link FastThreadLocalThread}引用的{@link InternalThreadLocalMap}，一个是基于
     * Native的{@link ThreadLocal<InternalThreadLocalMap>}拿的{@link InternalThreadLocalMap}.
     * commented by Yelin.G on 2021/06/20
     */
    ...
    private void expandIndexedVariableTableAndSet(int index, Object value) {
        ...
        /**
         * 这是个什么套路？简单点说就是得到离index最近的并且大于index的2^n值，举个例子：
         * 如果index=3，计算后的值就是4
         * 如果index=5，计算后的值就是8
         * 如果index=17，计算后的值就是32
         *
