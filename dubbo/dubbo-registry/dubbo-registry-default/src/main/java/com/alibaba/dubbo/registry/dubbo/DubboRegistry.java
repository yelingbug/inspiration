...
public class DubboRegistry extends FailbackRegistry {
    ...
    protected void doRegister(URL url) {
        registryService.register(url);//注意这里的registryService实际上是针对RegistryService接口包装的动态代理，是基于Invoker<RegistryService>包装的动态代理。比如下面这段代码(DubboRegistryFactory)#createRegistry()：
